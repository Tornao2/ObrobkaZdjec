...
namespace _qt_qml_KomunikacjaKomputerowa_Kontrolki_CustomButton_qml { 
    extern const unsigned char qmlData[];
    extern const QQmlPrivate::AOTCompiledFunction aotBuiltFunctions[];
    const QQmlPrivate::CachedQmlUnit unit = {
        reinterpret_cast<const QV4::CompiledData::Unit*>(&qmlData), &aotBuiltFunctions[0], nullptr
...
namespace _qt_qml_KomunikacjaKomputerowa_Ekrany_StartScreen_qml { 
    extern const unsigned char qmlData[];
    extern const QQmlPrivate::AOTCompiledFunction aotBuiltFunctions[];
    const QQmlPrivate::CachedQmlUnit unit = {
        reinterpret_cast<const QV4::CompiledData::Unit*>(&qmlData), &aotBuiltFunctions[0], nullptr
...
namespace _qt_qml_KomunikacjaKomputerowa_Ekrany_EditorScreen_qml { 
    extern const unsigned char qmlData[];
    extern const QQmlPrivate::AOTCompiledFunction aotBuiltFunctions[];
    const QQmlPrivate::CachedQmlUnit unit = {
        reinterpret_cast<const QV4::CompiledData::Unit*>(&qmlData), &aotBuiltFunctions[0], nullptr
...
Registry::Registry() {
    resourcePathToCachedUnit.insert(QStringLiteral("/qt/qml/KomunikacjaKomputerowa/Main.qml"), &QmlCacheGeneratedCode::_qt_qml_KomunikacjaKomputerowa_Main_qml::unit);
...
int QT_MANGLE_NAMESPACE(qInitResources_qmlcache_appKomunikacjaKomputerowa)() {
    ::unitRegistry();
    return 1;
}
Q_CONSTRUCTOR_FUNCTION(QT_MANGLE_NAMESPACE(qInitResources_qmlcache_appKomunikacjaKomputerowa))
int QT_MANGLE_NAMESPACE(qCleanupResources_qmlcache_appKomunikacjaKomputerowa)() {
    return 1;
}
